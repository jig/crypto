...
En el curso 2019-1 _no entrarán_ los paquetes de transparencias/videos marcados como opcionales en este índice de aquí debajo. Las transparencias/videos se han mantenido como material opcional.
  ...
  - [Criptografía simétrica, AES](https://jig.github.io/crypto/es/symmetric.html) `91` (&Sigma; → `126`) ([Cifrado de bloque, AES y modos de operación](https://jig.github.io/crypto/es/symmetric.html#block-cipher), resto OPCIONAL)
